...
export const GS = Object.freeze({
  ...
  chooseLetterExch:      ['בחר אות מהמגש להחלפה מהשקית (במקום יצירת מילה)', 'בחרי אות מהמגש להחלפה מהשקית (במקום יצירת מילה)'],
  ...
  descB1:                ['פתור את האנגרמה בזמן וקבל 100 נקודות', 'פתרי את האנגרמה בזמן וקבלי 100 נקודות'],
  descB3:                ['פתור את האנגרמה בזמן וקבל 40 נקודות',  'פתרי את האנגרמה בזמן וקבלי 40 נקודות'],
  ...
  // B11 explains the SELECTION mechanic explicitly: the player clicks the first
  // letter then the last one (hiddenWordMiniGame.checkSelection reads the line
  // between the two taps), the run must be exactly 3 letters, and readLine()
  // accepts horizontal / vertical / diagonal in either direction.
  descB11:               ['מצא מילה בת 3 אותיות ברשת 4×4: לחץ על האות הראשונה ואז על האחרונה. המילה יכולה להיות אופקית, אנכית או אלכסונית — בכל כיוון. 10 שניות!', 'מצאי מילה בת 3 אותיות ברשת 4×4: לחצי על האות הראשונה ואז על האחרונה. המילה יכולה להיות אופקית, אנכית או אלכסונית — בכל כיוון. 10 שניות!'],
  descB12:               ['בנה מילים על הכוורת שמכילות את האות שבאמצע לפחות פעם אחת',                      'בני מילים על הכוורת שמכילות את האות שבאמצע לפחות פעם אחת'],
